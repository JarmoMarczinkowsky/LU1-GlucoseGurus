    ...
    public async void ReadObject2Ds()
    {
        ...
        switch (webRequestResponse)
        {
            case WebRequestData<List<Object2D>> dataResponse:
                ...
                {
                    if (object2D.prefabId == "Table1")
                    {
                        GameObject newObject = Instantiate(Table1);
                        newObject.transform.localPosition = new Vector2(object2D.positionX, object2D.positionY);
                        //newObject.transform.SetParent(myCanvas.transform, false);
                    }
                    else if (object2D.prefabId == "Chair1")
                    {
                        GameObject newObject = Instantiate(Chair1);
                        newObject.transform.localPosition = new Vector2(object2D.positionX, object2D.positionY);
                        //newObject.transform.SetParent(myCanvas.transform, false);
                    }
                }
